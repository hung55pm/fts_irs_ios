...
class RedemOrderViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        tableview.register(RemOrderTableViewCell.self, forCellReuseIdentifier: "sub")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.setNavigationBarItem(title: "Redemption order")
        self.setNavigationBar(title: "Redemption order")
...
//        }
    ...
    func getdata(start:String, end: String, InvestorID: String,alertController : UIAlertController ) {
        connect.getredemptionOrder(investorID: InvestorID , stratdate: start, enddate: end, completionHandler: {(result) in
